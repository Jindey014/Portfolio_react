      ...
      <div>
        <div className="flex flex-wrap items-center justify-center gap-10 p-5 ">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <SiJquery className="cursor-pointer text-[80px] text-sky-800 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
          </motion.div>
          <motion.div
            variants={variants}
            initial="hidden"
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <BiLogoPostgresql className="cursor-pointer text-[80px] text-sky-400 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
          </motion.div>
          <motion.div
            variants={variants}
            initial="hidden"
            ...
            transition={{ duration: 0.5 }}
          >
            <RiNextjsLine className="cursor-pointer text-[80px] text-white transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
          </motion.div>
          <motion.div
            variants={variants}
            initial="hidden"
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <BiLogoGit className="cursor-pointer text-[80px] text-red-900 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
          </motion.div>
        </div>
      </div>
    </div>
